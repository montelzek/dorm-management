...
export const GET_AVAILABLE_STANDARD_SLOTS = gql`
  query GetAvailableStandardSlots($resourceId: ID!, $date: String!) {
    availableStandardSlots(resourceId: $resourceId, date: $date) {
      startTime
      endTime
    }
  }
